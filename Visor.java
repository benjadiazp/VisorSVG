...
import svg.figuras.*;
import svg.ASTDisplay;

public class Visor extends JPanel {

	private static LinkedList<Figura> figuras; //Arreglo que contiene las figuras obtenidas del Visitador.

	public void paint( Graphics g ) {
		Graphics2D g2 = (Graphics2D)g;
		for (int i=0; i < figuras.size(); i++) //Se recorre nuestro arreglo de figuras.
		{
	...
	public static void main( String[] args ) {
		...
		leerSVG(); //Este método hace casi todo.
	...
	/*
	Este método leerá el input de figuras en svg, aplicará el visitador y asignará
	el LinkedList del Visitador al arreglo de figuras de esta clase.
	*/
	{
