...
public interface Analysis extends Switch
{
    ...
    void caseALineFig0(ALineFig0 node);
    void caseACircleFig0(ACircleFig0 node);
    void caseARectFig0(ARectFig0 node);
    void caseAEllipseFig0(AEllipseFig0 node);
    void caseAPolygonFig0(APolygonFig0 node);
    void caseAPolylineFig0(APolylineFig0 node);
    void caseALineF(ALineF node);
    void caseACircleF(ACircleF node);
    void caseARectF(ARectF node);
    void caseAEllipseF(AEllipseF node);
    void caseAPolygonF(APolygonF node);
    void caseAPolylineF(APolylineF node);
