...
public class Visitador extends DepthFirstAdapter {
  public static LinkedList<Figura> lista = new LinkedList<>(); //Arreglo de figuras que puede ser accedido desde otras clases.
  private int tipoFig; //Tipo de figura que se está modificando.
  int contFig = 1;
  String attActual;
  Line line;
  Circle circle;
  ...
  */
  ...
  void agregarFigura()
  {
    ...
    contFig++;
    System.out.println(nombreFigura() + " agregada.\n"); //Confirmar que la figura se ha añadido al arreglo.
  ...
  Figura obtenerFigura()
  {
    ...
    switch (tipoFig)
    {
      case 1: fig = line; break;
      case 2: fig = circle; break;
      case 3: fig = rect; break;
      case 4: fig = ellipse; break;
      case 5: fig = polygon; break;
      case 6: fig = polyline; break;
      default: fig = null; break;
    }
    return fig;
  }
  ...
  {
    int val2=0;
    //Dependiendo del nombre del atributo actual, se asignará el valor obtenido en caseANUM();
    switch (attActual)
    {
  ...
  public void caseARectF(ARectF node)
  {
      ...
      {
        System.out.println("\nCrear rectángulo... (" + contFig + " figuras).");
        tipoFig = 3;
          rect = new Rectangle();
  ...
  public void caseAPolygonF(APolygonF node)
  {
      ...
      {
        System.out.println("\nCrear polígono... (" + contFig + " figuras).");
        tipoFig = 5;
          polygon = new Polygon();
  ...
  public void caseAPolylineF(APolylineF node)
  {
      ...
      {
        System.out.println("\nCrear polilínea... (" + contFig + " figuras).");
