...
public final class ABStart extends PStart
{
    ...
    public ABStart(
        ...
        @SuppressWarnings("hiding") PDim _dim_,
    ...
    public void setDim(PDim node)
    {
        if(this._dim_ != null)
        {
            this._dim_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._dim_ == oldChild)
        {
            setDim((PDim) newChild);
            return;
        }
